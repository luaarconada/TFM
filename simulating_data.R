...
for (i in 1:10) {
  ...
  sentence <- rnorm(n_samples, 5, 2)  # Length of Sentence (years)
  ...
  file_name <- paste0(data_dir, "/data", i, ".xlsx")
  ...
  hist_file_name <- paste0(data_dir, "/hist", i, ".png")
